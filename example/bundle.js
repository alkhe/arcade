...
var _expand = __webpack_require__(14);
...
var _domPatcher = __webpack_require__(13);
...
var expand = function expand(vnode, context) {
	for (;;) {
		...
		if ((0, _util.isString)(label)) {
			return (0, _vnode.fnode)(label, meta, (0, _util.getChildren)(vnode).map(function (vn) {
...
var _reduxDom = __webpack_require__(11);
...
var Root = function Root(_ref4) {
	var items = _ref4.items,
	    ...
	    addItem = _ref4.addItem;
	return (0, _vnode.fnode)('div', {}, ['\n\t\t', (0, _vnode.fnode)('input', {
